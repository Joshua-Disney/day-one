...
class JumpScene extends Phaser.Scene {
  ...
  create() {
    ...
    //Creates a rectangle background and fills it with a color gradient.
    ...
    //Sets up the jump animation for Codey
    this.anims.create({
      key: 'jump',
    ...
    // Sptripes to be used when "going fast"
  ...
  update(){
    ...
    // Creates the illusion of going fast with lines rushing by.
